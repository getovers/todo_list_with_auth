...
export default function Header() {
    const handlerSignOut = () => signOut({callbackUrl: "/login"});
    ...
    return (
        <header className="bg-gray-200 flex justify-between text-2xl py-5 px-10">
            ...
            <div className="h-full w-1/3 flex items-center justify-center font-semibold">{`Ласкаво просимо, ${username}`} <span>&#x1F44B;</span></div>
